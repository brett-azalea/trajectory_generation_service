...
class pose(object):
    ...
    def _encode_one(self, buf):
        buf.write(struct.pack(">fffffff", self.position_x, self.position_y, self.position_z, self.orientation_x, self.orientation_y, self.orientation_z, self.orientation_w))
    ...
    def _decode_one(buf):
        self = pose()
        self.position_x, self.position_y, self.position_z, self.orientation_x, self.orientation_y, self.orientation_z, self.orientation_w = struct.unpack(">fffffff", buf.read(28))
        return self
    _decode_one = staticmethod(_decode_one)

    def _get_hash_recursive(parents):
        if pose in parents: return 0
        tmphash = (0x7ba2ca086283294a) & 0xffffffffffffffff
